...
This is actually hopeless. One should instead use the construction of null states basis and one can find $D+1-1=D$ independent basis. Thus the total dof is $350-26=24$.
\end{paragraph}
\section{Problem 3}
...
\begin{equation}
\begin{aligned}[t]
\frac{1}{2}\sum\limits_{n=-\infty}^\infty \alpha_{m-n}^\gamma\alpha_n^\delta\eta_{\gamma\delta}(t_{\beta\theta\xi}\alpha_{-1}^\beta\alpha_{-1}^\theta\alpha_{-1}^\xi+s_{\mu\nu}\alpha_{-2}^\mu\alpha_{-1}^\nu+v_\sigma\alpha_{-3}^\sigma\ket{0;k})=0\\
\frac{1}{2}[\alpha_{m-1}^\gamma\alpha_1^\delta\eta_{\gamma\delta}t_{\beta\theta\xi}\alpha_{-1}^\beta\alpha_{-1}^\theta\alpha_{-1}^\xi+(\alpha_{m-1}^\gamma\alpha_1^\delta\eta_{\gamma\delta}+\alpha_{m-2}^\gamma\alpha_2^\delta\eta_{\gamma\delta})s_{\mu\nu}\alpha_{-2}^\mu\alpha_{-1}^\nu+\alpha_{m-3}^\gamma\alpha_3^\delta\eta_{\gamma\delta}v_\sigma\alpha_{-3}^\sigma]\ket{0;k}=0\\
\frac{1}{2}[\alpha_{m-1}^\gamma\eta_{\gamma\delta}t_{\beta\theta\xi}(\eta^{\delta\beta}\alpha_{-1}^\theta\alpha_{-1}^\xi+\eta^{\theta\delta}\alpha_{-1}^\beta\alpha_{-1}^\xi+\eta^{\delta\xi}\alpha_{-1}^\beta\alpha_{-1}^\theta)+s_{\mu\nu}(\alpha_{m-1}^\gamma\alpha_{-2}^\mu\eta^{\delta\nu}\eta_{\gamma\delta}+2\alpha_{m-2}^\gamma\alpha_{-1}^\nu\eta^{\delta\mu}\eta_{\gamma\delta})\\
+3\alpha_{m-3}^\gamma\eta_{\gamma\delta}v_\sigma\eta^{\delta\sigma}]\ket{0;k}=0
\end{aligned}
\end{equation} 
\end{document}
